...
final class a implements XmlSerializer {
    ...
    private final char[] b = new char[AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD];
    private int c;
    private Writer d;
    private OutputStream e;
    private CharsetEncoder f;
    private ByteBuffer g = ByteBuffer.allocate(AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD);
    private boolean h;
    ...
    private void a(String str, int i, int i2) throws IOException {
        if (i2 > AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD) {
            int i3 = i + i2;
            while (i < i3) {
                int i4 = i + AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD;
                a(str, i, i4 < i3 ? AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD : i3 - i);
                i = i4;
            }
            return;
        }
        int i5 = this.c;
        if (i5 + i2 > AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD) {
            flush();
            i5 = this.c;
        }
    ...
    private void a(char[] cArr, int i, int i2) throws IOException {
        if (i2 > AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD) {
            ...
            while (i < i3) {
                int i4 = i + AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD;
                a(cArr, i, i4 < i3 ? AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD : i3 - i);
                i = i4;
            }
            return;
        }
